...
# Create a new data frame with unique addresses and ZIP codes
...
# Sort the new data frame based on addresses
bronxadd <- bronxadd[order(bronxadd$ADDRESSONLY),]

# Identify duplicates in the original data frame
...
help(sample.int)
dim(bronxadd)
addsample<-bronxadd[sample.int(2251,size=nsample),]#I use nval here 
